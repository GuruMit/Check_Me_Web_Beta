...
interface Justification {
  ...
  type: string;
  isSelected?: boolean;
  file?: string; // Added the 'file' property
}
...
export default function AdminJustification() {
  ...
  const [selectedJustification, setSelectedJustification] =
    ...
    // useEffect(() => {
    //     setPdfUrl('https://cors-anywhere.herokuapp.com/https://www.orimi.com/pdf-test.pdf');
    // }, []);
      ...
      >
        ...
        <div className="flex flex-col px-2 space-y-1">
          <Link
            ...
            className={`flex items-center  ${sidebarExpanded
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="flex">
            ...
            {/* Right Section: Selected Justification Details */}
            <div className="w-1/3 pl-6">
              {selectedJustification && (
                <Card className="p-4 flex flex-col items-center">
                  <div className="flex w-full justify-between items-center">
                    <div className="max-w-[180px]">
                      <h2 className="text-lg font-semibold truncate text-slate-800">
                        {selectedJustification.courseName}
                      </h2>

                      <p className="text-sm text-gray-600"> {selectedJustification.type} </p>
                    </div>

                    <div>
                      <p className="text-lg text-slate-600">
                        {selectedJustification.timeSlot}
                      </p>
                      <p className="text-sm text-slate-600">
                  ...
                  <div className="mb-4 text-center mt-5">
                    ...
                    <div className="border rounded-md p-3 bg-gray-50 min-h-24 text-sm text-justify max-h-[150px] overflow-y-auto">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid illum voluptatibus ipsam? Necessitatibus tempora nam sed mollitia totam quae nihil debitis vel deleniti explicabo laudantium, maiores quis! Minima, est distinctio.
                      
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem illo a corrupti cupiditate cum, et vero voluptatum, eius eos minus asperiores, repellat nam aut pariatur dolor sed adipisci magni quod.
                    </div>
                  </div>

                  <div className="w-full mt-4 border rounded-md p-3">
                    <p className="text-sm text-gray-500 mb-1">Pièce jointe</p>
                    {selectedJustification.file === "PDF" ? (
                      <div className="w-full h-48 border rounded-md overflow-hidden">
                        {/* <Worker workerUrl="https://unpkg.com/pdfjs-dist@2.15.349/build/pdf.worker.min.js">
                          <div className="w-full h-full">
                            <Viewer
                              fileUrl="../Rapport_TDC_2024.pdf"
