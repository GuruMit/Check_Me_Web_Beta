...
export default function LoginPage() {
  ...
  const handleLogin = async (
    ...
    try {
      ...
      // For demo purposes - check if username and password match a demo account
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex justify-center ">
            <div className="relative h-16 w-64 flex justify-center items-center gap-3">
              <svg
                width="81"
                height="80"
                viewBox="0 0 98 91"
              ...
              >
                <rect
                  ...
                  width="97"
                  height="91"
                  fill="url(#pattern0_2777_468)"
                />
                <defs>
                  <pattern
                    id="pattern0_2777_468"
                    patternContentUnits="objectBoundingBox"
                    width="1"
                    height="1"
                  >
                    <use
                      xlinkHref="#image0_2777_468"
                      transform="matrix(0.00390625 0 0 0.0041638 0 -0.032967)"
                    />
                  </pattern>
                  <image
                    id="image0_2777_468"
                ...
                <div className=" right-0  absolute">
                  ...
                  >
                    <rect
                      ...
                      width="60"
                      height="29"
                      fill="url(#pattern0_2777_494)"
                    />
                    <defs>
                      <pattern
                        id="pattern0_2777_494"
                        patternContentUnits="objectBoundingBox"
                        width="1"
                        height="1"
                      >
                        <use
                          xlinkHref="#image0_2777_494"
                          transform="matrix(0.00952381 0 0 0.0197044 0 -0.00246305)"
                        />
                      </pattern>
                      <image
                        id="image0_2777_494"
                        ...
                        height="51"
                        preserveAspectRatio="none"
                        xlinkHref="data:image/png;base64,"
                      />
                    </defs>
                  </svg>
                </div>
              ...
              <Form className="space-y-3">
                  ...
                  <Field
                    ...
                    className={`h-12 w-full rounded-md border ${
                      errors.username && touched.username
                        ? "border-red-500"
                        : "border-slate-300"
                    } px-3 py-2 text-slate-700 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500`}
                  />
                  <ErrorMessage
                    name="username"
                    component="div"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <Link
                      href="/admin-psswrd-forgotten"
                      className="text-sm text-sky-500 hover:text-sky-600 hover:underline mt-1"
                    >
                      Mot de passe oublié?
                    </Link>
                  </div>
                ...
                <Button
                  type="submit"
                  className="h-12 w-full rounded-md bg-sky-500 font-medium text-white hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
          ...
          <div className="text-center text-sm">
            <span className="text-slate-600">Pas de compte ? </span>
